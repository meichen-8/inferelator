...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 23 15:34:56 2020
...
EXPRESSION_FILE_NAME = '103118_SS_Data.tsv'
GENE_METADATA_FILE_NAME = 'orfs.tsv'
GOLD_STANDARD_FILE_NAME = 'gold_standard.tsv'
METADATA_COLUMNS = ['Genotype', 'Genotype_Group', 'Replicate', 'Condition', 'tenXBarcode']
...
# %%
    ...
    worker.append_to_path('output_dir', 'figure_5d_stl_2')
