...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  7 11:01:59 2020
...
DATA_DIR = './data/'
OUTPUT_DIR = './output_tcc/'

growth_conditions=["DIAUXY", "YPETOH", "MMD", "MMETOH",  "NLIMNH4", "NLIMUREA", "NLIMGLN", "NLIMPRO", "YPD", "RAPA", "CSTARVE"]

EXPRESSION_FILE_NAME = 'expression_data/all_tcc.h5ad'
GOLD_STANDARD_FILE_NAME = 'gold_standard_tcc.tsv'
METADATA_COLUMNS = ['TF', 'strain', 'date', 'restriction', 'mechanism', 'time']

YEASTRACT_PRIOR = "YEASTRACT_20190713_BOTH_tcc-t.tsv"
...
def set_up_task(wkf, name):
    ...
    task.set_expression_file(h5ad = 'expression_data/'+name+'_tcc.h5ad')
